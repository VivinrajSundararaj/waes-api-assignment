...
import com.waes.api.base64.Base64DataComparator;
import com.waes.api.dao.BinaryDataDao;
...
public class WaesController {
    ...
    @RequestMapping(value = {
            "/diff/{id}/left"}, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
    ...
    @RequestMapping(value = {
            "/diff/{id}/right"}, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
