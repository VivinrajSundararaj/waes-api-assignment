package com.waes.api.integration;

import java.util.HashMap;
import java.util.Map;

import com.waes.api.WaesApiAssignmentApplication;
...
@SpringBootTest(classes = WaesApiAssignmentApplication.class, webEnvironment = WebEnvironment.DEFINED_PORT)
public class WaesIntegrationTests {
